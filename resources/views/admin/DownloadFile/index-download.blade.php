    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{route('admin.dashboard')}}" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                      <a href="{{route('admin.index_users')}}" class="nav-item nav-link "><i class="fa fa-user me-2"></i>User</a>
                    <a href="{{route('admin.index_download')}}" class="nav-item nav-link active"><i class="fa fa-file-pdf me-2"></i>Upload File</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <form action="{{ route('admin.searchdownload') }}" method="GET"  class="d-none d-md-flex ms-4">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <a class="btn btn-sm btn-success ms-2" href="{{ route('admin.download.file', ['id' => $upload->id]) }}">Download</a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
